...
module.exports = exports = FileMakerError;
 ...
 * @constructor
 */
function FileMakerError(code, url) {
    this.url = url;
    this.error = code;
...
FileMakerError.prototype = Object.create(Error.prototype);
FileMakerError.prototype.constructor = FileMakerError;
