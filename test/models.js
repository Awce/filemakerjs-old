...
describe('Models', function(){
    describe('Callback Flow', function(){
        ...
        describe("getDataBases(callback)", function(){
            ...
            it('expects to be a object back with an error property = 0', function(done){
        ...
        describe('getLayoutNames(databaseName, callback)', function(){
            it('callback should receive an object')
            it('callback should receive an object with property data')
        })

        describe('getScriptNames(databaseName, callback)', function(){
            it('callback should receive an object')
            it('callback should receive an object with property data')
        })
